...
//{
//    public class ModlInstances<M> where M : IModl, new()
//    {
//        public static List<ModlStructure> Tables = new List<ModlStructure>();
...
//        public static ModlSettings<M> Settings { get; private set; }
...
//            {
//                Id = GetContents(instance).GetValue<object>(IdName).ToString(),
//                ModlName = TableName
//            };
//        }
...
//            ModlStructure table = new Fields.ModlStructure();
...
//                    var getDelegate = (Func<M, object>)typeof(ModlInstances<M>).GetMethod("MakeGetDelegate", BindingFlags.Static | BindingFlags.NonPublic).MakeGenericMethod(property.PropertyType).Invoke(null, new object[] { property.GetGetMethod(true) });
//                    var setDelegate = (Action<M, object>)typeof(ModlInstances<M>).GetMethod("MakeSetDelegate", BindingFlags.Static | BindingFlags.NonPublic).MakeGenericMethod(property.PropertyType).Invoke(null, new object[] { property.GetSetMethod(true) });
